    ...
    <div>
      ...
      >
        ...
        <div className="p-2">
          ...
          <ToggleRow label="Pulse Panel" description="Show agent metadata sidebar in chat" checked={settings.debugPanel} onChange={(v) => onUpdate('debugPanel', v)} isDark={isDark} />
