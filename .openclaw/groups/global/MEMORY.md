...
**2026-02-27**: Moved group-related files into a new `.openclaw/groups` directory for better organization.

- Old paths like `groups/main/MEMORY.md` are now `.openclaw/groups/main/MEMORY.md`.
- This change centralizes OpenClaw-specific configuration and data.
