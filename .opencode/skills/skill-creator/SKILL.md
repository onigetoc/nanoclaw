...
description: Use when users want to create a new skill (or update an existing skill) that extends OpenCode's capabilities with specialized knowledge, workflows, or tool integrations. All scripts use TypeScript and run with Bun.
