...
EureClaw gives you the core functionality without that mess.
...
I don't need an installation wizard - OpenCode guides the setup. I don't need a monitoring dashboard - I ask OpenCode what's happening. I don't need elaborate logging UIs - I ask opencode to read the logs. I don't need debugging tools - I describe the problem and opencode fixes it.
...
- Custom `eureclaw` MCP server (inside container) provides scheduling tools
...
**EureClaw** - A reference to Clawdbot (now OpenClaw).
